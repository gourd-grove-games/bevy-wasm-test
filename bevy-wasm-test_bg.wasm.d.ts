...
export function wasm_bindgen__convert__closures__invoke1_mut__h0faf47de11fbecf8(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hae2569bd12471ed7(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hdd0fa10dd543d397(a: number, b: number, c: number): void;
